    ...
    <div className="p-2 sm:p-4">
      ...
      <div className="p-2 sm:p-4">
        <div className="flex justify-between items-start mb-2">
            <h2 className="text-2xl font-bold text-gray-800 pr-4">{landPlot.address}</h2>
        ...
        <p className="text-3xl font-light text-green-600 mb-4">${landPlot.price.toLocaleString('es-MX')}</p>
        <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-gray-600 mb-4 border-b pb-4">
        ...
        <div className="mb-4">
            <h3 className="text-lg font-semibold mb-2 text-gray-700">Uso de Suelo</h3>
        ...
        <p className="text-gray-700 mb-4">{landPlot.description}</p>
        <h3 className="text-lg font-semibold mb-2 text-gray-700">Servicios Disponibles</h3>
        <div className="flex flex-wrap gap-2">
            {landPlot.services.map(service => (
                <span key={service} className="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-1 rounded-full">{service}</span>
            ))}
        </div>
        <a 
