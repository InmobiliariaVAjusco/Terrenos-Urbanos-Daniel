  ...
  return (
    <section>
      <div className="mb-8 p-6 bg-white rounded-lg shadow-md border border-slate-200">
        <h2 className="text-3xl font-bold text-slate-900 mb-2">Encuentra tu Terreno Ideal</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 bg-white border border-slate-300 rounded-lg shadow-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 ease-in-out"
          ...
          <div className="relative">
            ...
            <select
              ...
              className="w-full appearance-none bg-white pl-10 pr-10 py-3 border border-slate-300 rounded-lg shadow-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 ease-in-out"
      ...
      {paginatedPlots.length > 0 ? (
        ...
        <div className="text-center py-16">
            <h3 className="text-xl font-semibold text-slate-700">No se encontraron terrenos</h3>
            <p className="text-slate-500 mt-2">Intenta ajustar tu búsqueda o filtros.</p>
        </div>
      )}
